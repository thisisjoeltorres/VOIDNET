...
import 'package:voidnet/views/components/checkbox-item.dart';
import 'package:voidnet/views/components/option-item.dart';
import 'package:voidnet/views/privacy_view.dart';
import 'package:voidnet/views/developer_view.dart';
import 'package:voidnet/views/styles/spaces.dart';
import 'package:voidnet/views/terms_view.dart';
            ...
            SliverList(
              delegate: SliverChildListDelegate([
                ...
                Padding(
                  ...
                  child: Text(AppLocalizations.of(context)!.aboutSection, textAlign: TextAlign.start, style: Theme.of(context).textTheme.headlineSmall, textScaler: const TextScaler.linear(1.0),),
                ),
